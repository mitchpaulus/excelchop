...
- Added `--csv` option for CSV output.

### Breaking

- Output to console is now always UTF-8 with no BOM.

## [0.10.0](https://github.com/mitchpaulus/excelchop/compare/v0.9.0...v0.10.0) - 2025-12-30

### Breaking

- Always start at `A1` if no explicit range is given.

## [0.9.0](https://github.com/mitchpaulus/excelchop/compare/v0.8.0...v0.9.0) - 2025-07-23
